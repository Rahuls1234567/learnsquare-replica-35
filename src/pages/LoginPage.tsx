            ...
            <div className="relative">
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-center lg:justify-start mb-8">
                  <div className="w-48 h-48 rounded-full bg-primary/5 flex items-center justify-center border border-primary/10">
                    <BookOpen className="w-20 h-20 text-primary/60" strokeWidth={1.2} />
                  </div>
                </div>
