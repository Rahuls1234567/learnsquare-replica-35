...
const LIST_TYPES = ['contact', 'syntaxwork', 'aicas', 'trainingRequest', 'testPrepPro', 'enrolment'] as const;
...
export async function GET(request: Request) {
    try {
        ...
        const [contact, syntaxwork, aicas, trainingRequest, testPrepPro, enrolment] = await Promise.all([
        ...
        const total = contact + syntaxwork + aicas + trainingRequest + testPrepPro + enrolment;
